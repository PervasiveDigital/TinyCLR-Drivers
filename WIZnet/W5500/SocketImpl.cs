...
namespace GHIElectronics.TinyCLR.Drivers.WIZnet.W5500 {
    internal class SocketImpl : ISocketImpl {
        private readonly WIZnet_W5500 parent;
        private int slot;
        ...
        public SocketImpl(WIZnet_W5500 parent, int slot, AddressFamily addressFamily, SocketType socketType, ProtocolType protocolType) {
            this.parent = parent;
            this.slot = slot;
